...
from dashboard.models import SuppressedContact
...
def _employee_cards() -> tuple[EmployeeCard, ...]:
    ...
    return (
        EmployeeCard(
            ...
            "Official Google Places discovery; closed businesses are filtered.",
            4,
        ),
        EmployeeCard(
            2,
            ...
            "Ready" if no_site_ready else "Website path ready",
            (
                "Website inspection plus independently verified no-website research."
                if no_site_ready
                else "Existing-site research works; no-website search needs SERPAPI_API_KEY."
            ),
            4,
        ),
        EmployeeCard(
            ...
            "ready",
            "Ready",
            "Deterministic evidence scoring; weak or unsupported leads stop here.",
            3,
        ),
        EmployeeCard(
            4,
            ...
            "Ready" if identity_ready else "Needs sender identity",
            "Creates outreach only from verified Researcher evidence.",
            3,
        ),
        EmployeeCard(
            5,
            ...
            "ready",
            "Adapter ready",
            "Requires digest-bound clearance and a final suppression check before Gmail.",
            2,
        ),
        EmployeeCard(
            6,
            ...
            "ready",
            "Ready",
            "Stops downstream work after any blocked, failed, or skipped stage.",
            2,
        ),
        EmployeeCard(
            7,
            ...
            "ready",
            "Ready",
            "Classifies replies, pauses automation, and persists opt-outs/negative replies.",
            1,
        ),
        EmployeeCard(
            8,
            ...
            "ready",
            "Ready",
            "Audits outcomes, prioritizes next actions, and computes worker KPI snapshots.",
            0,
        ),
    )
...
def company_dashboard(request):
    ...
    return render(
        ...
        {
            "employees": cards,
            "formation_rows": range(5),
            "employee_count": len(cards),
            "suppression_count": SuppressedContact.objects.count(),
